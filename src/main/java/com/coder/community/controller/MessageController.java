...
//                System.out.println("我没有问题"+ targetId + "一." +message.getFromId() + "二."+message.getToId() +"三."+user.getId());
...
//        System.out.println("我没有错"+letterUnreadCount);
        return "/site/letter";
    }
    ...
    public String getNoticeList(Model model) {
        ...
        if(message != null) {
            ...
            System.out.println("评论未读数量为："+ unread);
       ...
       message = messageService.findLatestNotice(user.getId(), TOPIC_LIKE);
        ...
        if(message != null) {
            ...
            messageVo.put("unread", unread);
            System.out.println("点赞未读数量为："+ unread);
//            System.out.println("我真的点赞了！");
...
//            System.out.println(messageVo);
        ...
        if(message != null) {
            ...
            System.out.println("关注未读数量为："+ unread);
        }
